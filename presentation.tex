...
\frametitle{Outline}
  ...
  \note[item]{I will start by motivating the importance of this topic to inequality researchers and outlining my research question.}
  ...
  \note[item]{Finally, I'll discuss some implications and a theoretical model I think my results might imply.}
\end{frame}
