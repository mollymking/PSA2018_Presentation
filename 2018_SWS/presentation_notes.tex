...
\begin{figure}[ht]
    \begin{center}
      \includegraphics[width=0.8\linewidth]{"/Users/mollymking/Documents/SocResearch/Dissertation/results/figures/08_vis/ki08_vis06_graphCIs_C_edu_all-gender"}
...
\begin{figure}[ht]
    \begin{center}
      \includegraphics[width=0.8\linewidth]{"/Users/mollymking/Documents/SocResearch/Dissertation/results/figures/08_vis/ki08_vis03_propHoriz02_multComp_C_edu_gender"}
...
\end{itemize}
 % And even though your data can’t speak to this, you might want to briefly explain your thoughts on the broader social forces shaping the results. I know you have thought a lot about this, so you could just add one or two sentences on it. What came to mind for me is Maria Charles' research and the research on gender sorting by field among teachers professors. Erin Cech’s work on the passion principle and college degrees might also be helpful here. This would help to showcase the broader significance of your findings.
